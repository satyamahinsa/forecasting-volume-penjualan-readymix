...
@st.cache_resource
def load_model():
    return joblib.load("models/model_sarimax_sbb.pkl")
...
def show():
    ...
    st.dataframe(st.session_state.df_sbb, use_container_width=True)

    df_filtered = st.session_state.df_sbb.copy()
    ...
    try:
        ...
        exog_features = ['BI Rate', 'APBN Infra', 'Effective Working Days',
                            'Volume_lag1', 'Volume_lag2', 'Volume_lag3',
                            'Volume_lag6', 'Volume_roll_mean_3']
